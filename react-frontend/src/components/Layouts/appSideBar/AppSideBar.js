                ...
                },
{
                  icon: <Home />,
                  label: "Measurements",
                  menuKey: "measurements",
                  to: "/app/measurements",
                },
{
                  icon: <Home />,
                  label: "Identify Type",
                  menuKey: "identifyType",
                  to: "/app/identifyType",
                },
{
                  icon: <Home />,
                  label: "E-invoice Types",
                  menuKey: "eInvoiceTypes",
                  to: "/app/eInvoiceTypes",
                },
{
                  icon: <Home />,
                  label: "Classification Codes",
                  menuKey: "classificationCodes",
                  to: "/app/classificationCodes",
                },
{
                  icon: <Home />,
                  label: "Payment Modes",
                  menuKey: "paymentModes",
                  to: "/app/paymentModes",
                },
{
                  icon: <Home />,
                  label: "Frequency Of Billing",
                  menuKey: "frequencyOfBilling",
                  to: "/app/frequencyOfBilling",
                },
{
                  icon: <Home />,
                  label: "Currency Codes",
                  menuKey: "currencyCodes",
                  to: "/app/currencyCodes",
                },
{
                  icon: <Home />,
                  label: "Phone Number Prefix",
                  menuKey: "phoneNumberPrefix",
                  to: "/app/phoneNumberPrefix",
                },
{
                  icon: <Home />,
                  label: "State Codes",
