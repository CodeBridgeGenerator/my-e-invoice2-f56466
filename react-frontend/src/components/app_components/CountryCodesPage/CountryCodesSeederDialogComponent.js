...
import seederData from "./countryCodes.seeder.json";
...
const CountryCodesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CountryCodesSeederDialogComponent);
