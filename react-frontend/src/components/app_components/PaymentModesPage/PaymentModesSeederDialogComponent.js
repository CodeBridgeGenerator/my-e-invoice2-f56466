...
import seederData from "./paymentModes.seeder.json";
...
const PaymentModesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PaymentModesSeederDialogComponent);
