...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="eInvoiceTypes-add-button"/>
...
/>            
      ...
      />
            ...
            <EInvoiceTypesCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
