...
const SuppliersPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("suppliers")
            .find({ query: { $limit: 10000 , suppliersName : urlParams.singleCompaniesId ,identifierType : urlParams.singleIdentifyTypeId ,theFirstSuppliersContactNumber : urlParams.singlePhoneNumberPrefixId ,countryName : urlParams.singleCountryCodesId ,stateName : urlParams.singleStateCodesId ,team : urlParams.singleTeamsId ,invoiceId : urlParams.singleInvoicesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
