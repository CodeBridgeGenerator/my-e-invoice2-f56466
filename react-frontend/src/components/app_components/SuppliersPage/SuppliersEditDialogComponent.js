...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="prePaymentDate" value={_entity?.prePaymentDate ? new Date(_entity?.prePaymentDate) : null} onChange={ (e) => setValByKey("prePaymentDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
