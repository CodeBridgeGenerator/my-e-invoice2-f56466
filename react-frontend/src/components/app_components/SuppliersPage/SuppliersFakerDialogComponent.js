...
const SuppliersFakerDialogComponent = (props) => {
    ...
    const [suppliersNameIds, setsuppliersNameIds] = useState();
...
client.service("invoices")
    ...
    const onRun = async () => {
        let fakeData = suppliersFakerFactory(props.user,fakerCount,suppliersNameIds,identifierTypeIds,theFirstSuppliersContactNumberIds,countryNameIds,stateNameIds,teamIds,invoiceIdIds);
