...
import seederData from "./taxTypes.seeder.json";
...
const TaxTypesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TaxTypesSeederDialogComponent);
