...
import seederData from "./stateCodes.seeder.json";
...
const StateCodesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StateCodesSeederDialogComponent);
