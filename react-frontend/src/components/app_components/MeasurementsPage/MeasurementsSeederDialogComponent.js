...
import seederData from "./measurements.seeder.json";
...
const MeasurementsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MeasurementsSeederDialogComponent);
