...
const [paymentMode, setPaymentMode] = useState([])
    ...
    useEffect(() => {
        ...
        if (!_.isEmpty(props?.entity)) {
            init = initilization({ ...props?.entity, ...init }, [buyersName,identifierType,buyersAddressCountryName,buyersAddressStateName,theFirstBuyersContactNumber,invoiceCurrency,frequencyOfBilling,paymentMode], setError);
        }
        set_entity({...init});
        setError({});
    }, [props.show]);
    ...
    useEffect(() => {
                    ...
                    client
                        ...
                        .then((res) => {
                            setBuyersName(res.data.map((e) => { return { name: e['name'], value: e._id }}));
                        })
                        .catch((error) => {
                            console.debug({ error });
...
useEffect(() => {
    ...
    const buyersNameOptions = buyersName.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Create Buyers" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            ...
            <span className="align-items-center">
                ...
                <Dropdown id="buyersName" value={_entity?.buyersName?._id} optionLabel="name" optionValue="value" options={buyersNameOptions} onChange={(e) => setValByKey("buyersName", {_id : e.value})}  />
            </span>
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="billingPeriodStartDate"  value={_entity?.billingPeriodStartDate ? new Date(_entity?.billingPeriodStartDate) : null} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("billingPeriodStartDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="billingPeriodEndDate"  value={_entity?.billingPeriodEndDate ? new Date(_entity?.billingPeriodEndDate) : null} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("billingPeriodEndDate", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
