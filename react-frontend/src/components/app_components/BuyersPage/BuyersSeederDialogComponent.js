...
import seederData from "./buyers.seeder.json";
...
const BuyersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BuyersSeederDialogComponent);
