...
const p_dateTemplate15 = (rowData, { rowIndex }) => <p >{moment(rowData.billingPeriodStartDate).fromNow()}</p>
const p_dateTemplate16 = (rowData, { rowIndex }) => <p >{moment(rowData.billingPeriodEndDate).fromNow()}</p>
