...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="identifyType-add-button"/>
...
/>            
      ...
      />
            ...
            <IdentifyTypeCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
