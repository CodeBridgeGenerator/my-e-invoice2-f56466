...
import seederData from "./classificationCodes.seeder.json";
...
const ClassificationCodesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ClassificationCodesSeederDialogComponent);
