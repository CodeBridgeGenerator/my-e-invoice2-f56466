...
const ShippingEditDialogComponent = (props) => {
...
const [shippingRecipientsIdentifierType, setShippingRecipientsIdentifierType] = useState([])
 ...
 useEffect(() => {
    ...
    const onSave = async () => {
        let _data = {
            shippingRecipientsName: _entity?.shippingRecipientsName?._id,
...
export default connect(mapState, mapDispatch)(ShippingEditDialogComponent);
