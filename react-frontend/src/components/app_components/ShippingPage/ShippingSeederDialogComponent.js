...
import seederData from "./shipping.seeder.json";
...
const ShippingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ShippingSeederDialogComponent);
