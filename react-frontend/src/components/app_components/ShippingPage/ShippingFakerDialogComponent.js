...
const ShippingFakerDialogComponent = (props) => {
    ...
    const [shippingRecipientsNameIds, setshippingRecipientsNameIds] = useState();
...
const [shippingRecipientsIdentifierTypeIds, setshippingRecipientsIdentifierTypeIds] = useState();
    ...
    useEffect(() => {
        ...
        client.service("companies")
                        ...
                        .then((data) => {
                        setshippingRecipientsNameIds(data.data);
                        });
...
client.service("identifyType")
    ...
    const onRun = async () => {
        let fakeData = shippingFakerFactory(props.user,fakerCount,shippingRecipientsNameIds,shippingRecipientsAddressCountryNameIds,shippingRecipientsAddressStateNameIds,shippingRecipientsIdentifierTypeIds);
