...
const PhoneNumberPrefixPage = (props) => {
    ...
    const filename = "phoneNumberPrefix";
            ...
            <div className="grid">
                <div className="col-6 flex align-items-center justify-content-start">
                    <h4 className="mb-0 ml-2">
                        <span> My App /{" "}</span>
                        <strong>Phone Number Prefix </strong>
                    </h4>
                    <SplitButton
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="phoneNumberPrefix-add-button"/>
...
/>            
      ...
      />
            ...
            <PhoneNumberPrefixCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
