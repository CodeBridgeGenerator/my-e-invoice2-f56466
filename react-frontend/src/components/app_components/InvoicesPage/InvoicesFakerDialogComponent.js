...
client.service("companies")
    ...
    const onRun = async () => {
        let fakeData = invoicesFakerFactory(props.user,fakerCount,invoiceTypeIds,classificationIds,countryOfOriginIds,taxTypeIds,taxType1Ids,teamsIds,buyerIds,supplierIds);
