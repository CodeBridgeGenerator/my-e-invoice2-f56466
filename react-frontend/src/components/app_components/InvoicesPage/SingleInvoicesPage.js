...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description 1</label><p className="m-0 ml-3" >{_entity?.description1}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Discount Amount 1</label><p className="m-0 ml-3" >{Number(_entity?.discountAmount1)}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description 3</label><p className="m-0 ml-3" >{_entity?.description3}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description 4</label><p className="m-0 ml-3" >{_entity?.description4}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Tax Type 1</label>
                    {taxType1.map((elem) => (
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Supplier</label>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Suppliers" leftIcon="pi pi-building-columns mr-2">
                        <SuppliersPage/>
                    </TabPanel>
                    

                    <TabPanel header="Buyers" leftIcon="pi pi-building-columns mr-2">
                        <BuyersPage/>
                    </TabPanel>
