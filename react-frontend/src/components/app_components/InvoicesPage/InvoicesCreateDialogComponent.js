...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="invoiceDateAndTime"  value={_entity?.invoiceDateAndTime ? new Date(_entity?.invoiceDateAndTime) : null} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("invoiceDateAndTime", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                <label htmlFor="taxType1">Tax Type 1:</label>
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                <label htmlFor="discountAmount1">Discount Amount 1:</label>
