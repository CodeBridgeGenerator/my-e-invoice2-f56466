...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="invoiceDateAndTime" value={_entity?.invoiceDateAndTime ? new Date(_entity?.invoiceDateAndTime) : null} onChange={ (e) => setValByKey("invoiceDateAndTime", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
