...
export default (user,count,invoiceTypeIds,classificationIds,countryOfOriginIds,taxTypeIds,taxType1Ids,teamsIds,buyerIds,supplierIds) => {
    let data = [];
...
teams: teamsIds[i % teamsIds.length],
