...
import seederData from "./currencyCodes.seeder.json";
...
const CurrencyCodesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CurrencyCodesSeederDialogComponent);
