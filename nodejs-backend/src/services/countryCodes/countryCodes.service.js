const { CountryCodes } = require("./countryCodes.class");
const createModel = require("./countryCodes.model");
const hooks = require("./countryCodes.hooks");
...
module.exports = function (app) {
  ...
  app.use("/countryCodes", new CountryCodes(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("countryCodes");

  // Get the schema of the collections 
  app.get("/countryCodesSchema", function (request, response) {
